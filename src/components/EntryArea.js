            ...
            <div className="row entry-static-wrap">
              <div className="col-lg-3">
                <div className="entry-static-box entry-static-box1">
                  ...
                  <h4 className="entry__title">E Ola Pono Ma Kapolei's Vision</h4>
                </div>
              </div>
                    ...
                    <div className="col-lg-8">
                      <div className="entry-video-text">
                        <h4 className="entry__title">
                          Kapolei 96707 is a unified and thriving community where people are resilient, living healthy and drug free
                        </h4>
